...
;(function( $ ){
    ...
    if ($('[data-ac-repeater]').length > 0){
        ...
        $('[data-ac-repeater]').each(function (i) {
            ...
            var repeaterText = elementToRepeat.attr('data-ac-repeater-text') ? elementToRepeat.attr('data-ac-repeater-text') : '+';
            var adderId = 'acAdder' + i;
            var adder = '<button class="form-group col-md-2" id="'+adderId+'">'+repeaterText+'</button>'
